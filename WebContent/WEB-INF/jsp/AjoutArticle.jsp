	...
	<div class="container-fluid">
		...
		<main>
			...
			<div class="mx-auto text-center">
				...
				<img class="mb-4 large-icon rounded-circle" src="images/article.svg"
					alt="">
			</div>
				...
				<div class="row">
					<div class="col-md-6 mb-3">
						<label for="dateDebutEncheres">Date de début de l'enchère
							...
							name="dateDebutEncheres" value="" required>
						<div class="invalid-feedback">Veuillez sélectionner une date
						</div>
					</div>
